...
import { deleteWithIdAndUpdate, ensureListExistId, validatedBodyMiddleware } from './middlewares';
...
app.patch('/purchaseList/:id/:name',deleteWithIdAndUpdate,updateItemList)
